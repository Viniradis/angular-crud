...
export class ExcluirComponent implements OnInit {
  ...
  constructor(private produtoService: ProdutoService, private router: Router, @Inject(MAT_DIALOG_DATA) public data: any, private ref:MatDialogRef<ExcluirComponent>) { }
